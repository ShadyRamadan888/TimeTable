...
public class fall extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Query query=firebaseFirestore.collection("tasks").document(firebaseUser.getUid()).collection("MyTasks").orderBy("title", Query.Direction.ASCENDING);
        ...
        noteAdapter=new FirestoreRecyclerAdapter<firebasemodel, NoteViewHolder>(allusertasks) {
            ...
            protected void onBindViewHolder(@NonNull NoteViewHolder holder, int position, @NonNull firebasemodel model) {
                ...
                popupbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        deleteFromAllSection(popupMenu,docId);
                        popupMenu.show();
                    }
                });
            }
    ...
    void deleteFromAllSection(PopupMenu popupMenu,String docId){
